...
<html>
	...
	<body>
	<?php
		if ((!isset($_POST['admin_id']))||($_POST['admin_id']!=$_SESSION['user_id']))
		...
		else
		{
			...
			if (isset($table))
			{
				...
				if ($c = oci_new_connect(username,password,db)) 
				{
					...
					echo '<a href = "adminpage.php"><----- Come Back</a>';
					...
					echo '<input type = "hidden" name = "admin_id" value ="'.$_SESSION['user_id'].'">';
